...
<html>
<head>
    <title>Privacy Policy for MinerStats</title>
    <meta charset="utf-8">
        ...
        <div class="en section_container active" section-language="en">
            <div id="md_en" data-target="out_en" class="agreement_md"><h1>Terms and Conditions</h1>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and
                            ...
                            Terms
                            and Conditions agreement has been created with the help of the <a
                    ...
                    <li>
                        <p><strong>Website</strong> refers to MinerStats, accessible from <a
                                href="https://miner-stats.com/"
                                rel="external nofollow noopener"
                                target="_blank">https://miner-stats.com/</a>
                        </p>
                    </li>
                    <li>
                ...
                <p>Your access to and use of the Service is conditioned on Your acceptance of and compliance with these
                    Terms
                    and Conditions. These Terms and Conditions apply to all visitors, users and others who access or use
                    the
                    Service.</p>
                ...
                <p>To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be
                    ...
                    Service,
                    third-party software and/or third-party hardware used with the Service, or otherwise in connection
                    with any
                ...
                <p>The Service is provided to You "AS IS" and "AS AVAILABLE" and with all faults and defects without
                    warranty of
                    any kind. To the maximum extent permitted under applicable law, the Company, on its own behalf and
                    on behalf
                    of its Affiliates and its and their respective licensors and service providers, expressly disclaims
                    all
                    warranties, whether express, implied, statutory or otherwise, with respect to the Service, including
                    all
                    ...
                    representation of
                    any kind that the Service will meet Your requirements, achieve any intended results, be compatible
                    or work
                ...
                <p>Without limiting the foregoing, neither the Company nor any of the company's provider makes any
                    ...
                    of the
                    Service, or the information, content, and materials or products included thereon; (ii) that the
                    Service will
                    be uninterrupted or error-free; (iii) as to the accuracy, reliability, or currency of any
                    information or
                ...
                <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use
                    of the
                    Service. Your use of the Application may also be subject to other local, state, national, or
                    international
                    laws.</p>
                ...
                <p>You represent and warrant that (i) You are not located in a country that is subject to the United
                    ...
                    supporting"
                    country, and (ii) You are not listed on any United States government list of prohibited or
                    restricted
                    parties.</p>
                ...
                <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation
                    under
                    this Terms shall not effect a party's ability to exercise such right or require such performance at
                    any time
                ...
                <ul>
                    <li>By visiting this page on our website: <a href="https://miner-stats.com/"
                                                                 rel="external nofollow noopener" target="_blank">https://miner-stats.com/</a>
                    </li>
                </ul>
            </div>
